...
class OIDAGToDAGISel : public SelectionDAGISel {
  /// Subtarget - Keep a pointer to the OI Subtarget around so that we can
...
bool OIDAGToDAGISel::SelectADDRri(SDValue Addr,
...
bool OIDAGToDAGISel::SelectADDRrr(SDValue Addr, SDValue &R1, SDValue &R2) {
...
SDNode *OIDAGToDAGISel::Select(SDNode *N) {
...
/// inline asm expressions.
bool
OIDAGToDAGISel::SelectInlineAsmMemoryOperand(const SDValue &Op,
                                                char ConstraintCode,
                                                std::vector<SDValue> &OutOps) {
  SDValue Op0, Op1;
