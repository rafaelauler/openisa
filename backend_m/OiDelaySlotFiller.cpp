//===-- DelaySlotFiller.cpp - Oi Delay Slot Filler ----------------------===//
//
...
static cl::opt<bool> DisableDelaySlotFiller(
  ...
  cl::init(false),
  cl::desc("Disable the delay slot filler, which attempts to fill the Oi"
...
static cl::opt<bool> SkipDelaySlotFiller(
  "skip-oi-delay-filler",
  cl::init(false),
  cl::desc("Skip OI' delay slot filling pass."),
  cl::Hidden);
...
void Filler::insertDefsUses(InstrIter MI,
  ...
  E = MI->getNumOperands();
  for (; I != E; ++I)
    insertDefUse(MI->getOperand(I), RegDefs, RegUses, Oi::AT);
}
