//===-- OiReginfo.cpp - Registerinfo handling  --------------------------===//
//
...
void
OiReginfo::emitOiReginfoSectionCG(MCStreamer &OS,
    ...
    const OiSubtarget &MST) const
{
  ...
  const OiTargetObjectFile &TLOFELF =
      static_cast<const OiTargetObjectFile &>(TLOF);
