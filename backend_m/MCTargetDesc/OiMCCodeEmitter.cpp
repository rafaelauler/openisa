...
public:
  OiMCCodeEmitter(const MCInstrInfo &mcii, MCContext &Ctx_, bool IsLittle) :
...
MCCodeEmitter *llvm::createOiMCCodeEmitterEB(const MCInstrInfo &MCII,
                                               ...
                                               MCContext &Ctx)
{
  return new OiMCCodeEmitter(MCII, Ctx, false);
}
...
MCCodeEmitter *llvm::createOiMCCodeEmitterEL(const MCInstrInfo &MCII,
                                               ...
                                               MCContext &Ctx)
{
  return new OiMCCodeEmitter(MCII, Ctx, true);
}
                  ...
                  SmallVectorImpl<MCFixup> &Fixups) const
{
  ...
  // in the first place!
  if ((TSFlags & OiII::FormMask) == OiII::Pseudo)
