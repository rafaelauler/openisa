...
set output '| ps2pdf -dEPSCrop -dAutoRotatePages=/None - spec.pdf'
...
set title "SPEC CPU2006 OpenISA to x86 Translation"
...
plot 'spec_runtime.csv' using ($0-0.3):3:4:xticlabels(2) with boxerrorbars title "Globals" ls 1, \
