//===-- FPMover.cpp - OI double-precision floating point move fixer ----===//
//
...
namespace {
  struct FPMover : public MachineFunctionPass {
    ...
    virtual const char *getPassName() const {
      return "OI Double-FP Move Fixer";
    }
...
/// createOIFPMoverPass - Returns a pass that turns FpMOVD
/// instructions into FMOVS instructions
///
FunctionPass *llvm::createOIFPMoverPass(TargetMachine &tm) {
