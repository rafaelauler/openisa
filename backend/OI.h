...
namespace llvm {
  ...
  FunctionPass *createOIDelaySlotFillerPass(TargetMachine &TM);
  FunctionPass *createOIFPMoverPass(TargetMachine &TM);

} // end namespace llvm;

namespace llvm {
  // Enums corresponding to OI condition codes, both icc's and fcc's.  These
  ...
  inline static const char *OICondCodeToString(SPCC::CondCodes CC) {
    switch (CC) {
