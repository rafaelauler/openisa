...
int main(int argc, char **argv)
{
  ...
  if (gf.gtkflag) gtkcontrol(&gf);
    ...
    do {
      ...
      //      printf("Dumping contents of mp3buffer\n");
      //      for (int i = 0; i < sizeof(mp3buffer); ++i) {
      //        printf("%08X %02X", i, mp3buffer[i] & 0xFF);
      //        ++i;
      //        for (int y = i; y % 16 != 0 && y < sizeof(mp3buffer); ++y, ++i) {
      //          printf(" %02X", mp3buffer[y] & 0xFF);
      //        }
      //        --i;
      //        printf("\n");
      //      }
